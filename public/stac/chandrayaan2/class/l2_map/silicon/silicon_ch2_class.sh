#!/bin/bash
# ============================================================
# Chandrayaan-2 CLASS - L2 Elemental Abundance Map, Silicon
# Source    : ch2_cla_l2_map_si_v1.tif/.xml (PDS4, ISRO ISDA/PRADAN)
# Output    : silicon_ch2_class_COG.tif
...
SRC_TIF="$SCRIPT_DIR/ch2_cla_l2_map_si_v1.tif"
OUT_COG="$SCRIPT_DIR/silicon_ch2_class_COG.tif"
