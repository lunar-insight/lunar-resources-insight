#!/bin/bash
# ============================================================
# Chandrayaan-2 CLASS - L2 Elemental Abundance Map, Magnesium
# Source    : ch2_cla_l2_map_mg_v1.tif/.xml (PDS4, ISRO ISDA/PRADAN)
# Output    : magnesium_ch2_class_COG.tif
...
SRC_TIF="$SCRIPT_DIR/ch2_cla_l2_map_mg_v1.tif"
OUT_COG="$SCRIPT_DIR/magnesium_ch2_class_COG.tif"
