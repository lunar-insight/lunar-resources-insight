#!/usr/bin/env bash
# Generate COG GeoTIFF from Kaguya MI Derived Olivine Weight Percent 50N50S 512ppd 59mpp (Lemelin et al. 2016)
#
# Source file: Lunar_Kaguya_MIMap_MineralDeconv_OlivinePercent_50N50S.tif
...
#   Download: https://astrogeology.usgs.gov/search/map/kaguya_lunar_multiband_imager_mi_derived_olivine_weight_percent_50n50s_512ppd_59mpp
#
# Output : olivine_kaguya_mi_lemelin2016_COG.tif (wt%, NoData = -9999, IAU:30100)
# GDAL   : 3.12.2
#
...
SRC="${1:-Lunar_Kaguya_MIMap_MineralDeconv_OlivinePercent_50N50S.tif}"
OUT="olivine_kaguya_mi_lemelin2016_COG.tif"
TMP="olivine_kaguya_mi_lemelin2016_wtpct_tmp.tif"
