#!/usr/bin/env bash
# Generate COG GeoTIFF from Kaguya MI Derived Plagioclase Weight Percent 50N50S 512ppd 59mpp (Lemelin et al. 2016)
#
# Source file: Lunar_Kaguya_MIMap_MineralDeconv_PlagioclasePercent_50N50S.tif
...
#   Download: https://astrogeology.usgs.gov/search/map/kaguya_lunar_multiband_imager_mi_derived_plagioclase_weight_percent_50n50s_512ppd_59mpp
#
# Output : plagioclase_kaguya_mi_lemelin2016_COG.tif (wt%, NoData = -9999, IAU:30100)
# GDAL   : 3.12.2
#
...
SRC="${1:-Lunar_Kaguya_MIMap_MineralDeconv_PlagioclasePercent_50N50S.tif}"
OUT="plagioclase_kaguya_mi_lemelin2016_COG.tif"
TMP="plagioclase_kaguya_mi_lemelin2016_wtpct_tmp.tif"
