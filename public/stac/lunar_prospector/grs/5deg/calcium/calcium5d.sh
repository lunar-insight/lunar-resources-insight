#!/bin/bash
# ============================================================
# Lunar Prospector - Calcium 5°
# Source    : calcium5d.dat (PDS, version June 15 2002)
# Output    : calcium5d_COG.tif
# CRS       : IAU:30100 (Moon 2015 / Ocentric)
# Units     : Ca weight percent (raw INT16 ÷ 10)
# GDAL      : 3.12.2
# PROJ      : 9.8.0
...
# Step 1 - Scale raw INT16 → Float32 Ca wt%
gdal_calc.py \
  -A calcium5d.vrt \
