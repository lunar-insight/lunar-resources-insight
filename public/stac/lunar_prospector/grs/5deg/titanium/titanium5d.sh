#!/bin/bash
# ============================================================
# Lunar Prospector - Titanium 5°
# Source    : titanium5d.dat (PDS, version June 15 2002)
# Output    : titanium5d_COG.tif
# CRS       : IAU:30100 (Moon 2015 / Ocentric)
# Units     : Ti weight percent (raw INT16 ÷ 10)
# GDAL      : 3.12.2
# PROJ      : 9.8.0
