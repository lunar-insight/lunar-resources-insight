#!/bin/bash
# ============================================================
# Lunar Prospector – Epithermal Neutron Pixon Reconstruction
# Source    : jgre20969-sup-0002-supplementary.txt (Dataset S1)
# Reference : Wilson et al. 2018, JGR Planets, doi:10.1029/2018JE005589
# Output    : epithermal_wilson_COG.tif
# CRS       : IAU:30100 (Moon 2015 / Ocentric)
# Units     : counts/32s (Float32)
# Grid      : 1024 × 512 equal-angle rectangular, full Moon
# Pixel     : 0.3515625° (~10.7 km at equator, 61 km effective resolution)
# GDAL      : 3.12.2
# PROJ      : 9.8.0
...
SRC_TXT="$SCRIPT_DIR/jgre20969-sup-0002-supplementary.txt"
TMP_ASC="$SCRIPT_DIR/epithermal_wilson_tmp.asc"
OUT_COG="$SCRIPT_DIR/epithermal_wilson_COG.tif"
...
#           pixel data is already north→south, no pre-processing flip needed
gdal_translate \
  -of COG \
  -a_srs IAU:30100 \
